...
def find_rectangular_overlap(rect1, rect2):
    ...
    x1 = max(rect1['left_x'], rect2['left_x'])
    y1 = max(rect1['bottom_y'], rect2['bottom_y'])
    x2 = min(rect1['left_x'] + rect1['width'], rect2['left_x'] + rect2['width'])
    y2 = min(rect1['bottom_y'] + rect1['height'], rect2['bottom_y'] + rect2['height'])
    ...
    return {'left_x': x1, 'bottom_y': y1, 'width': width, 'height': height}
